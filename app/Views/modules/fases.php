            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card card-default">
                        <div class="card-header" <?php if(session()->rol == 'Participante' || $listado){ echo 'style="display:none;visibility:hidden;"'; } else { echo 'style="visibility:visible;"';}?> style="padding: 2em 0; background-color: aliceblue;">
