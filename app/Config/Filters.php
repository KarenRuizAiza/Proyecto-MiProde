...
class Filters extends BaseConfig
{
    ...
    public $aliases = [
        ...
        'adminFilter'  => LoggedAdminFilter::class
    ];
     ...
     */
    public $filters = [
        'loggedFilter' => ['before' => ['usuarios', 'apuestas', 'fixture/*', 'equipos', 'torneos', 'fases/torneo=(:num)', 'partidos/fase=(:num)', 'desafios', 'invitaciones']],
